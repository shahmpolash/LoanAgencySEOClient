                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                {/* <h3 className='mb-5'> Add Your Pricing Package</h3> */}
                                ...
                                {/* <form class="contact-form " onSubmit={handlePricing}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="default-btn" data-delay=".8s"> Add Package</button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="pricingTable">
                                        ...
                                        <div class="pricingTable-signup">
                                            <Link to={`/package-edit/${pri._id}`} className='default-btn'>Edit Pricing</Link>
                                        </div>
                                    </div>
                                </div>
                            )}
